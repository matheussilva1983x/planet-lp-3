        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 px-4" onClick={() => setOpen(false)}>
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={start} className="p-5 md:p-6 space-y-3">
              ...
              <input className="w-full h-11 px-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#25D366]" placeholder="Endereço de e-mail *" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required />
