  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(13, 58, 46, 0.7), rgba(13, 58, 46, 0.7)), url(/Julho-Lugares-jpg.jpg)`,
          ...
          <div className="grid gap-10 md:grid-cols-2 items-center">
            <div className="text-center md:text-left">
              ...
              <h1 className="-mt-6 sm:-mt-8 md:-mt-10 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-1 animate-fade-in leading-tight max-w-4xl">
                Alojamentos incríveis com conforto e segurança.
              </h1>
              <p
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button
            ...
            onClick={openLeadModal}
          >
            Quero encontrar o meu destino agora
          </Button>
        </div>
      </section>
          ...
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl p-6 md:p-8" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={submitLead} className="space-y-4">
              ...
              <div>
                ...
                <input id="lead-email" type="email" value={leadEmail} onChange={(e) => setLeadEmail(e.target.value)} required className="w-full h-12 px-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#C2855E] bg-white" placeholder="o.seu@email.pt" />
              </div>
      ...
      <WhatsAppFloat phone="5599999999999" message="Olá! Quero ajuda para encontrar o meu destino." />
    </div>
  );
};
